...
def get_stats(ids, counts=None):
    ...
    for pair in zip(ids, ids[1:]): # iterate consecutive pairs of elements
...
class BasicBPETokenizer:
    ...
    def _build_vocab(self):
        ...
        # bytes([0]) = b'\x00'
        vocab = {idx: bytes([idx]) for idx in range(256)} # {0: b'\x00', 1: b'\x01', 2: b'\x02', 3: b'\x03', ...}
    ...
    def save(self, file_prefix):
        ...
        with open(model_file, 'w') as f:
            # write the version and merges, that's all that's needed
            f.write("playBPE v1\n")
